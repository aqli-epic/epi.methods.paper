...
* Drop certain rows:
  * **(Why?)**Where Age intervals is one of: Neonatal, [0, 1], [5, 14], [15, 49], [50, 69], [70, inf], [80, inf], [10, 24], [10, 54], [10, 19]. It looks like that from one year to the next, the `age_ids` to `age_name` mapping remains the same in GBD. But, still check this in the GBD dataset that you are using. If the mapping has changed, just make sure that you drop those `age_ids` that correspond to the following `age_names` listed earlier in this point.
...
# drop the following age_ids: 23, 24, 25, 26, 28, 159, 162, 169
