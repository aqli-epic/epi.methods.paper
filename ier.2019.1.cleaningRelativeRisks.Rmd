...
#> Spelling correction for the following cause of death: Ischemic heart disease. Change the spelling of "Ischaemic" to "Ischemic"
rr_dataset_2019 <- rr_dataset_2019 %>%
  mutate(cause = ifelse(cause == "Ischaemic heart disease", "Ischemic heart disease", cause))
...
age_wise_rr_data_available <- c("Ischemic heart disease", "Stroke")
