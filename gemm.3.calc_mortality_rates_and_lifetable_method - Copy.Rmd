...
#> Read in the cleaned gemm mortality rates file for 5 causes of deaths as per the gemm paper.
...
cleaned_joined_gemm_mort_5cod_rr_data <- cleaned_gemm_mortality_rates_5_cod %>%
